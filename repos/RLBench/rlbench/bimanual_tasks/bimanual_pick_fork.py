    ...
    def _setup_phased_evaluator(self):
        ...
        phase3_conditions = [
            ...
            ClearPathCondition(
                ...
                lift_waypoints=lift_waypoints, min_clearance=0.25
            )
        ]
        ...
        logging.info(f"PhasedSuccessEvaluator initialized for BimanualPickFork (scheme: {self.active_waypoint_mode})")
