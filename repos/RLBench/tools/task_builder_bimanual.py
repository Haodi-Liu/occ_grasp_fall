...
if __name__ == '__main__':
    ...
    # ===== 解析命令行参数 =====
    parser = argparse.ArgumentParser(description='Bimanual Task Builder')
    parser.add_argument('--ttt', type=str, default=None,
                        help='Custom TTT file (e.g., left_task_design_bimanual.ttt)')
    ...
    # ===== 支持自定义 TTT =====
    if args.ttt:
        ttt_file = join(CURRENT_DIR, '..', 'rlbench', args.ttt)
    else:
