...
class KeypointPosePredictor(nn.Module):
    ...
    *** Key Design Changes (Path B) ***
    ...
    Input:
        ...
        Visual-only: no proprioception input.
    ...
    def forward(self, visual_feat, img_tokens=None):
        """
        ...
        Args:
            ...
            Visual-only: keypoint prediction does not use proprioception.
        ...
        # ====== 3. Multi-layer Decoder processing ======
        for i in range(self.num_layers):
            # 3.1 Self-Attention: keypoint interaction (Pre-LN)
            residual = kp_queries
            ...
            # 3.2 Cross-Attention: localize from visual features (Pre-LN)
            residual = kp_queries
        ...
        # ====== 6. [KEEP] Visibility prediction (affordance) ======
        ...
        # ====== 7. [NEW] Return kp_queries as features for condition injection ======
