...
class DETRVAE(nn.Module):
    ...
    def __init__(self, backbones, transformer, encoder, state_dim,
        ...
        self.encoder_action_proj = nn.Linear(self.input_dim, hidden_dim) # project action to embedding
        self.encoder_joint_proj = nn.Linear(self.input_dim, hidden_dim)  # project qpos to embedding
    ...
    def forward(self, qpos, image, env_state, actions=None, is_pad=None):
        ...
        if is_training:
            # project action sequence and qpos to embedding dim, and concat with a CLS token
