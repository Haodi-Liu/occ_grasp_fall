...
#
# Modified for ACT_BC_ENC_STRATEGY: Added strategy_type and phase_type support
...
from agents.act_bc_enc_strategy.act_bc_enc_agent import ActBCEncAgent
from helpers.custom_rlbench_env import CustomRLBenchEnv
from helpers.preprocess_agent import PreprocessAgent
from agents.act_bc_enc_strategy.act_policy import ACTPolicy, CNNMLPPolicy
...
# Strategy and Phase type mappings (for validation and debugging)
STRATEGY_TYPES = {
    0: 'EdgeHang',
    1: 'WallLever',
    2: 'PressTilt'
...
def create_replay(batch_size: int, timesteps: int,
    ...
    # Strategy and Phase type labels (new for ACT_BC_ENC_STRATEGY)
    # Values are 0-based indices (converted from 1-based in data collection)
    # strategy_type: 0=EdgeHang, 1=WallLever, 2=PressTilt
    # phase_type: 0=PreManipulation, 1=Grasp, 2=ClearPath, 3=Lift
    observation_elements.append(
...
def _add_keypoints_to_replay(
    ...
    # Phase type (1-based in data -> 0-based for model)
