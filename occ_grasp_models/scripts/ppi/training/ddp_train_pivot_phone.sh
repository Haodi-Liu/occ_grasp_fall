...
torchrun --nnodes 1 --nproc_per_node $ngpus --master_port 10004 train_ppi_ddp.py \
    ...
    task.dataset.stats_filepath='data/training_processed/norm_stats/norm_stats_bimanual_pivot_phone_rgb_pcd_rps6144_keyframe_continuous_world_ordered_rps200.pth' \
    horizon_keyframe=4 \
    horizon_continuous=50 \
    dataloader.batch_size=32 \
    val_dataloader.batch_size=32 \
    training.num_epochs=480 \
    seed=0 \
