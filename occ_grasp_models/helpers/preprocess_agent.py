...
class PreprocessAgent(Agent):
    ...
    def set_aux_eval_cfg(self, cfg):
        if hasattr(self._pose_agent, "set_aux_eval_cfg"):
            self._pose_agent.set_aux_eval_cfg(cfg)

    def set_episode_index_path(self, path: str):
        if hasattr(self._pose_agent, "set_episode_index_path"):
            self._pose_agent.set_episode_index_path(path)
